...
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/compose.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/http-exception.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/request/constants.js
var GET_MATCH_RESULT = /* @__PURE__ */ Symbol();
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/utils/body.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/utils/url.js
var splitPath = (path) => {
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/request.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/utils/html.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/context.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/router.js
var METHODS = [
	"get",
	"post",
	"put",
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/utils/constants.js
var COMPOSED_HANDLER = "__COMPOSED_HANDLER";
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/hono-base.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/router/reg-exp-router/matcher.js
var emptyParam = [];
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/router/reg-exp-router/node.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/router/reg-exp-router/trie.js
var Trie = class {
	#context = { varIndex: 0 };
	#root = new Node$1();
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/router/reg-exp-router/router.js
var nullMatcher = [
	/^$/,
	[],
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/router/smart-router/router.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/router/trie-router/node.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/router/trie-router/router.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/hono.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/utils/handler.js
var findTargetHandler = (handler) => {
	return handler["__COMPOSED_HANDLER"] ? findTargetHandler(handler[COMPOSED_HANDLER]) : handler;
};
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/utils/accept.js
...
var consumeWhitespace = (acceptHeader, startIndex) => {
	while (startIndex < acceptHeader.length) {
		if (!isWhitespace(acceptHeader.charCodeAt(startIndex))) break;
		startIndex++;
	}
	return startIndex;
};
var ignoreTrailingWhitespace = (acceptHeader, startIndex) => {
	while (startIndex > 0) {
		if (!isWhitespace(acceptHeader.charCodeAt(startIndex - 1))) break;
		startIndex--;
	}
	return startIndex;
};
var skipInvalidParam = (acceptHeader, startIndex) => {
	while (startIndex < acceptHeader.length) {
		...
		if (char === 59) return [startIndex + 1, true];
		if (char === 44) return [startIndex + 1, false];
		startIndex++;
	}
...
var skipInvalidAcceptValue = (acceptHeader, startIndex) => {
	...
	while (i < acceptHeader.length) {
		...
		if (inQuotes && char === 92) i++;
		else if (char === 34) inQuotes = !inQuotes;
		else if (!inQuotes && char === 44) return i + 1;
		i++;
	}
	return i;
};
...
var getNextAcceptValue = (acceptHeader, startIndex) => {
	...
	while (i < acceptHeader.length) {
		...
		if (char === 59 || char === 44) {
			...
			i++;
			if (char === 44) return [i, accept.type ? accept : void 0];
			if (!accept.type) return [skipInvalidAcceptValue(acceptHeader, i), void 0];
			break;
		}
		i++;
	}
	if (!accept.type) {
		accept.type = acceptHeader.slice(startIndex, ignoreTrailingWhitespace(acceptHeader, acceptHeader.length));
	...
	while (i < acceptHeader.length) {
		...
		if (param && value) accept.params[param] = value;
		if (!hasNext) break;
	}
	return [i, accept];
};
var parseAccept = (acceptHeader) => {
	...
	while (i < acceptHeader.length) {
		...
		if (accept) {
			...
			values.push(accept);
			if (lastAccept && lastAccept.q < accept.q) requiresSort = true;
			lastAccept = accept;
		}
	}
	if (requiresSort) values.sort((a, b) => b.q - a.q);
	return values;
};
var parseQuality = (qVal) => {
	if (qVal === void 0) return 1;
	if (qVal === "") return 1;
	if (qVal === "NaN") return 0;
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/utils/compress.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/middleware/compress/index.js
...
var compress = (options) => {
	...
	return async function compress2(ctx, next) {
		...
		const encoding = selectEncoding(ctx.req.header("Accept-Encoding"), candidates);
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/middleware/cors/index.js
var cors = (options) => {
	const opts = {
		origin: "*",
		allowMethods: [
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/utils/color.js
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/middleware/logger/index.js
var humanize = (times) => {
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/middleware/secure-headers/secure-headers.js
var HEADERS_MAP = {
...
function getPermissionsPolicyDirectives(policy) {
	return Object.entries(policy).map(([directive, value]) => {
		...
		if (typeof value === "boolean") return `${kebabDirective}=${value ? "*" : "none"}`;
		if (Array.isArray(value)) {
			if (value.length === 0) return `${kebabDirective}=()`;
			if (value.length === 1 && (value[0] === "*" || value[0] === "none")) return `${kebabDirective}=${value[0]}`;
...
//#endregion
//#region node_modules/.deno/hono@4.12.23/node_modules/hono/dist/helper/adapter/index.js
...
//#endregion
export { compress as a, HTTPException as c, cors as i, secureHeaders as n, findTargetHandler as o, logger as r, Hono as s, adapter_exports as t };
